...
def train(cfg):
    ...
    for n_iter in range(cfg.train.max_iters):
        ...
        if (n_iter + 1) % cfg.train.log_iters == 0:
            ...
            writer.add_scalars('train/loss',  {"seg_loss": seg_loss.item(), "attn_loss": attn_loss.item(), "proto_loss": proto_loss.item(), "proto_align": proto_align.item()}, global_step=n_iter)
            writer.add_scalars(
                'train/ema',
                {
